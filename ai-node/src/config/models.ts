export const modelConfig = {
  ...
  openai: [
    ...
    { name: 'gpt-5.4', supportsImages: true, supportsAttachments: true },
  ],
  openrouter: [
    { name: 'deepseek/deepseek-v3.2', supportsImages: false, supportsAttachments: true },
    { name: 'xiaomi/mimo-v2-pro', supportsImages: false, supportsAttachments: true },
    { name: 'xiaomi/mimo-v2-omni', supportsImages: true, supportsAttachments: true },
    { name: 'google/gemini-3.1-pro-preview', supportsImages: true, supportsAttachments: true },
  ],
  xai: [
    ...
    { name: 'grok-4.20', supportsImages: true, supportsAttachments: true },
  ],
};
